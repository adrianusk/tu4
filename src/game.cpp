...
/*
 * Mouse areas for text mode: 44x44 map viewport at (2,2)-(45,45).
 * Four triangles splitting the viewport into directional quadrants.
 * Center point is (24,24). Coordinates in character cells.
 */
MouseArea mouseAreas[] = {
    { 3, { { 2, 2 }, { 2, 45 }, { 24, 24 } }, MC_WEST, { U4_ENTER, 0, U4_LEFT } },
    { 3, { { 2, 2 }, { 45, 2 }, { 24, 24 } }, MC_NORTH, { U4_ENTER, 0, U4_UP }  },
    { 3, { { 45, 2 }, { 45, 45 }, { 24, 24 } }, MC_EAST, { U4_ENTER, 0, U4_RIGHT } },
    { 3, { { 2, 45 }, { 45, 45 }, { 24, 24 } }, MC_SOUTH, { U4_ENTER, 0, U4_DOWN } },
